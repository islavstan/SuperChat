...
public interface PublicChatPresenter {
    ...
    void loadPrivateData(DBMethods dbMethods, ChatsRecyclerAdapter adapter);

    void loadPrivateDataWithOutInternet(DBMethods dbMethods, ChatsRecyclerAdapter adapter);
